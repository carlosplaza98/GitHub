    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO users (usuario, clave, noticias, usuarios) VALUES ('$usuario','$clave_encriptada',$noticias,$usuarios)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE users SET usuario='$usuario',clave='$clave_encriptada',noticias=$noticias,usuarios=$usuarios WHERE id='$id'") :
