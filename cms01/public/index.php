...
function controlador($nombre=null){
    ...
    switch($nombre){
        ...
        case "news": return new NoticiaController;
        case "users": return new UsuarioController;
    }
...
switch ($ruta){
    ...
    case "admin":
    case "admin/entrar":
        controlador("users")->entrar();
        break;
    case "admin/salir":
        controlador("users")->salir();
        break;
    case "admin/usuarios":
        controlador("users")->index();
        break;
    case "admin/usuarios/crear":
        controlador("users")->crear();
        break;
    case (strpos($ruta,"admin/usuarios/editar/") === 0):
        controlador("users")->editar(str_replace("admin/usuarios/editar/","",$ruta));
        break;
    case (strpos($ruta,"admin/usuarios/activar/") === 0):
        controlador("users")->activar(str_replace("admin/usuarios/activar/","",$ruta));
        break;
    case (strpos($ruta,"admin/usuarios/borrar/") === 0):
        controlador("users")->borrar(str_replace("admin/usuarios/borrar/","",$ruta));
        break;
    case "admin/noticias":
        controlador("news")->index();
        break;
    case "admin/noticias/crear":
        controlador("news")->crear();
        break;
    case (strpos($ruta,"admin/noticias/editar/") === 0):
        controlador("news")->editar(str_replace("admin/noticias/editar/","",$ruta));
        break;
    case (strpos($ruta,"admin/noticias/activar/") === 0):
        controlador("news")->activar(str_replace("admin/noticias/activar/","",$ruta));
        break;
    case (strpos($ruta,"admin/noticias/home/") === 0):
        controlador("news")->home(str_replace("admin/noticias/home/","",$ruta));
        break;
    case (strpos($ruta,"admin/noticias/borrar/") === 0):
        controlador("news")->borrar(str_replace("admin/noticias/borrar/","",$ruta));
        break;
